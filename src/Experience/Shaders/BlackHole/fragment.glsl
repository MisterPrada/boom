...
void main()
{
    ...
    color -= 0.2 * vec3(0.0, 0.0, uTime * 4.0);
    ...
    gl_FragColor.a = smoothstep(1.0, 0.9, gl_FragColor.r * fac);
    gl_FragColor.rgb = smoothstep(vec3(0.5), vec3(7.5), gl_FragColor.rgb);
    //gl_FragColor.rgb = clamp(gl_FragColor.rgb, 0.0, 0.3);
    //gl_FragColor.a = smoothstep(0.9, 0.8, mix(0.0, 0.1, gl_FragColor.r));
